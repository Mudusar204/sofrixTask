...
const Card1 = () => {
  return (
    <div className="card1 px-[30px] py-[70px] flex flex-1 justify-between gap-[30px] max-lg:flex-col">
      ...
      <div className="bg-white flex justify-between items-center rounded-[25px] w-[66%] max-lg:w-full">
        <img
          ...
          alt=""
        />
        <p className="text-[#127398] text-[30px] leading-[40px] font-[500] pl-[120px] pr-[50px] max-lg:pl-4 max-lg:pr-0 max-md:m-5">
          <b className="text-[33px]"> Sign up today</b> and manage your
          portfolio like a pro with personalized assistant and access to a
          trusted tech community of 1,200 members who connected $150M+ of total
          assets.
        </p>
      </div>
    </div>
